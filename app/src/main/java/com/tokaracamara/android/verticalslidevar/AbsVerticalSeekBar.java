...
public class AbsVerticalSeekBar extends VerticalProgressBar{
    ...
    public AbsVerticalSeekBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            Drawable thumb = a.getDrawable(R.styleable.VerticalSeekBar_thumb);
            setThumb(thumb); // will guess mThumbOffset if thumb != null...
            // ...but allow layout to override this
            int thumbOffset = a.getDimensionPixelOffset(R.styleable.VerticalSeekBar_thumbOffset, getThumbOffset());
            setThumbOffset(thumbOffset);
            mDisabledAlpha = a.getFloat(R.styleable.VerticalSeekBar_disabledAlpha, 0.5f);
        } finally {
            a.recycle();
        }
